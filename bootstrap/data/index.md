...
<div class="row">
	<div class="container">
		...
		<div class="col-sm-4">
			...
			<p>Research on marine ecosystems is active across the Channel. Explore the data with this interactive maps and learn more about our local marine ecosystems.</p>
		...
		<div class="col-sm-4">
			...
			<p>Learn about how SBC MBON's data is processed and prepared for access.</p>
		...
		<div class="col-sm-4">
			...
			<h2>Data Catalog</h2>
			<p>Most of SBC MBON's datasets are ongoing time-series. Browse and download the most up-to-date data from SBC MBON data catalog.</p>
